story_text = {
    "intro": [
        ...
        "3 elemen yang dapat mencegah krisis energi Bumi akan dicari Sarah, dalam bentuk batuan mineral. Mineral yang pertama adalah Nethonite. Menurut prediksi Sarah, Nethonite merupakan mineral yang terdiri sepenuhnya dari Dimensium, elemen dengan interaksi paling aneh yang diketahui manusia. Apabile Nethonite diputar dengan kecepatan >32 ribu RPM dalam sebuah bola kaca tebal hampa, Nathonite dapat menghasilkan listrik yang stabil dengan tegangan yang luar biasa.",
