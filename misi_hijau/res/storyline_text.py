...
story_text = {
    "intro": [
        "Sekarang tahun 3000. Manusia kemungkinan besar akan berhasil menjadi makhluk pertama yang dapat pergi ke galaksi lain dan benar-benar menjadi penguasa alam ini. 100 tahun yang lalu, seluruh negara di bumi bergabung dalam ISRP (International Space Research Project), organisasi raksasa yang akan melakukan banyak penelitian terhadap dunia luar angkasa.",
    ...
    "outro_message": [
        "Tim Sarah pun pulang ke bumi, dengan membawa mineral-mineral yang telah terkumpul. Terima kasih atas bantuanmu, ilmuwan muda! Kamu adalah generasi penerus bangsa ini. Maknailah hidup yang misterius ini dengan terus belajar dan belajar untuk memajukan kehidupan manusia."
    ]
